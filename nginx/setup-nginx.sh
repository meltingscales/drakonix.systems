...
echo "       :3001  meowderall (meowderall.drakonix.systems)"
echo "       :3002  carethermometer (carethermometer.drakonix.systems)"
echo "       :3003  donationaggregator (donationaggregator.drakonix.systems)"
